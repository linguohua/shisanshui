...
const (
	...
	// 断线、奔溃恢复，注意恢复过程是由若干个消息构成，先是OPRoomUpdate，然后是OPRestore(消息体是MsgRestore)，然后是OPActionAllowed或者OPReActionAllowed
...
func (x *MsgDeal) GetWindFlowerID() int32 {
	if x != nil && x.WindFlowerID != nil {
		return *x.WindFlowerID
	}
	return 0
}
...
func (x *MsgDeal) GetCardsInWall() int32 {
...
func (x *MsgDeal) GetDice1() int32 {
	if x != nil && x.Dice1 != nil {
		return *x.Dice1
	}
	return 0
}

func (x *MsgDeal) GetDice2() int32 {
	if x != nil && x.Dice2 != nil {
		return *x.Dice2
	}
	return 0
}

func (x *MsgDeal) GetIsContinuousBanker() bool {
	if x != nil && x.IsContinuousBanker != nil {
		return *x.IsContinuousBanker
	}
	return false
}

func (x *MsgDeal) GetMarkup() int32 {
...
func (x *MsgActionResultNotify) GetActionHand() *MsgCardHand {
	if x != nil {
		return x.ActionHand
	}
	return nil
...
type MsgPlayerScoreGreatWin struct {
	...
	// 基本的赢牌分数，也即是trimGreatWinPoints乘以每个辣子对应的分数,
	// NOTE: 废弃不用
...
func (x *MsgPlayerScoreGreatWin) Reset() {
	*x = MsgPlayerScoreGreatWin{}
	if protoimpl.UnsafeEnabled {
...
func (x *MsgPlayerScoreGreatWin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgPlayerScoreGreatWin) ProtoMessage() {}

func (x *MsgPlayerScoreGreatWin) ProtoReflect() protoreflect.Message {
	mi := &file_poker_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgPlayerScoreGreatWin.ProtoReflect.Descriptor instead.
func (*MsgPlayerScoreGreatWin) Descriptor() ([]byte, []int) {
	return file_poker_proto_rawDescGZIP(), []int{9}
}

func (x *MsgPlayerScoreGreatWin) GetBaseWinScore() int32 {
	if x != nil && x.BaseWinScore != nil {
		return *x.BaseWinScore
	}
	return 0
}

func (x *MsgPlayerScoreGreatWin) GetGreatWinType() int32 {
	if x != nil && x.GreatWinType != nil {
		return *x.GreatWinType
	}
	return 0
}

func (x *MsgPlayerScoreGreatWin) GetGreatWinPoints() int32 {
	if x != nil && x.GreatWinPoints != nil {
		return *x.GreatWinPoints
	}
	return 0
}

func (x *MsgPlayerScoreGreatWin) GetTrimGreatWinPoints() int32 {
	if x != nil && x.TrimGreatWinPoints != nil {
		return *x.TrimGreatWinPoints
	}
	return 0
}

func (x *MsgPlayerScoreGreatWin) GetContinuousBankerExtra() int32 {
	if x != nil && x.ContinuousBankerExtra != nil {
		return *x.ContinuousBankerExtra
	}
	return 0
}
...
func (x *MsgPlayerScoreMiniWin) Reset() {
	*x = MsgPlayerScoreMiniWin{}
	if protoimpl.UnsafeEnabled {
...
func (x *MsgPlayerScoreMiniWin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgPlayerScoreMiniWin) ProtoMessage() {}

func (x *MsgPlayerScoreMiniWin) ProtoReflect() protoreflect.Message {
	mi := &file_poker_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgPlayerScoreMiniWin.ProtoReflect.Descriptor instead.
func (*MsgPlayerScoreMiniWin) Descriptor() ([]byte, []int) {
	return file_poker_proto_rawDescGZIP(), []int{10}
}

func (x *MsgPlayerScoreMiniWin) GetMiniWinType() int32 {
	if x != nil && x.MiniWinType != nil {
		return *x.MiniWinType
	}
	return 0
}

func (x *MsgPlayerScoreMiniWin) GetMiniWinBasicScore() int32 {
	if x != nil && x.MiniWinBasicScore != nil {
		return *x.MiniWinBasicScore
	}
	return 0
}

func (x *MsgPlayerScoreMiniWin) GetMiniWinFlowerScore() int32 {
	if x != nil && x.MiniWinFlowerScore != nil {
		return *x.MiniWinFlowerScore
	}
	return 0
}

func (x *MsgPlayerScoreMiniWin) GetMiniMultiple() int32 {
	if x != nil && x.MiniMultiple != nil {
		return *x.MiniMultiple
	}
	return 0
}

func (x *MsgPlayerScoreMiniWin) GetMiniWinTrimScore() int32 {
	if x != nil && x.MiniWinTrimScore != nil {
		return *x.MiniWinTrimScore
	}
	return 0
}

func (x *MsgPlayerScoreMiniWin) GetContinuousBankerExtra() int32 {
	if x != nil && x.ContinuousBankerExtra != nil {
		return *x.ContinuousBankerExtra
	}
	return 0
...
func (x *MsgPlayerScore) GetWinType() int32 {
...
func (x *MsgPlayerScore) GetScore() int32 {
...
func (x *MsgPlayerScore) GetSpecialScore() int32 {
	if x != nil && x.SpecialScore != nil {
		return *x.SpecialScore
	}
	return 0
}

func (x *MsgPlayerScore) GetGreatWin() *MsgPlayerScoreGreatWin {
	if x != nil {
		return x.GreatWin
	}
	return nil
...
func (x *MsgPlayerScore) GetMiniWin() *MsgPlayerScoreMiniWin {
	if x != nil {
		return x.MiniWin
	}
	return nil
...
func (x *MsgPlayerScore) GetFakeWinScore() int32 {
	if x != nil && x.FakeWinScore != nil {
		return *x.FakeWinScore
	}
	return 0
}

func (x *MsgPlayerScore) GetFakeList() []int32 {
	if x != nil {
		return x.FakeList
	}
	return nil
...
func (x *MsgPlayerScore) GetIsContinuousBanker() bool {
	if x != nil && x.IsContinuousBanker != nil {
		return *x.IsContinuousBanker
	}
	return false
...
func (x *MsgPlayerScore) GetContinuousBankerMultiple() int32 {
	if x != nil && x.ContinuousBankerMultiple != nil {
		return *x.ContinuousBankerMultiple
	}
	return 0
}
...
var file_poker_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_poker_proto_goTypes = []interface{}{
	...
	(*MsgPlayerScoreGreatWin)(nil), // 11: xproto.MsgPlayerScoreGreatWin
	(*MsgPlayerScoreMiniWin)(nil),  // 12: xproto.MsgPlayerScoreMiniWin
	(*MsgPlayerScore)(nil),         // 13: xproto.MsgPlayerScore
	(*MsgHandScore)(nil),           // 14: xproto.MsgHandScore
	(*MsgHandOver)(nil),            // 15: xproto.MsgHandOver
	(*MsgUpdateLocation)(nil),      // 16: xproto.MsgUpdateLocation
	(*MsgUpdatePropCfg)(nil),       // 17: xproto.MsgUpdatePropCfg
}
var file_poker_proto_depIdxs = []int32{
	...
	3,  // 3: xproto.MsgActionResultNotify.actionHand:type_name -> xproto.MsgCardHand
	5,  // 4: xproto.MsgRestore.msgDeal:type_name -> xproto.MsgDeal
	3,  // 5: xproto.MsgRestore.prevActionHand:type_name -> xproto.MsgCardHand
	11, // 6: xproto.MsgPlayerScore.greatWin:type_name -> xproto.MsgPlayerScoreGreatWin
	12, // 7: xproto.MsgPlayerScore.miniWin:type_name -> xproto.MsgPlayerScoreMiniWin
	13, // 8: xproto.MsgHandScore.playerScores:type_name -> xproto.MsgPlayerScore
	4,  // 9: xproto.MsgHandOver.playerCardLists:type_name -> xproto.MsgPlayerCardList
	14, // 10: xproto.MsgHandOver.scores:type_name -> xproto.MsgHandScore
...
func file_poker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_poker_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgPlayerScoreGreatWin); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_poker_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgPlayerScoreMiniWin); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
